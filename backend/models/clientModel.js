...
// class Client {
//   constructor(reference_client, nom_client, adresse_client, code_postal, email_client, telephone_client) {
...
//     const { reference_client, nom_client, adresse_client, code_postal, email_client, telephone_client } = clientData;
//     const query = 'INSERT INTO client (reference_client, nom_client, adresse_client, code_postal, email_client, telephone_client) VALUES (?, ?, ?, ?, ?, ?)';
//     db.query(query, [reference_client, nom_client, adresse_client, code_postal, email_client, telephone_client], (err, results) => {
//       if (err) {
//         return callback(err);
//       }
...
//     const { reference_client, nom_client, adresse_client, code_postal, email_client, telephone_client } = clientData;
//     const query = 'UPDATE client SET reference_client = ?, nom_client = ?, adresse_client = ?, code_postal = ?, email_client = ?, telephone_client = ? WHERE id_client = ?';
//     db.query(query, [reference_client, nom_client, adresse_client, code_postal, email_client, telephone_client, id], (err, results) => {
//       if (err) {
//         return callback(err);
//       }
//       callback(null, results);
