...
namespace StartingBloch.Backend.Migrations
{
    ...
    [Migration("20250819145259_AdjustActorPaysFkDeleteBehavior")]
    partial class AdjustActorPaysFkDeleteBehavior
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("StartingBloch.Backend.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 8, 19, 14, 52, 59, 308, DateTimeKind.Utc).AddTicks(7061),
                            Description = "Employé StartingBloch - Administrateur avec accès complet et gestion des utilisateurs",
                            Name = "admin",
                            UpdatedAt = new DateTime(2025, 8, 19, 14, 52, 59, 308, DateTimeKind.Utc).AddTicks(7063)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2025, 8, 19, 14, 52, 59, 308, DateTimeKind.Utc).AddTicks(7067),
                            Description = "Employé StartingBloch - Utilisateur standard avec droits configurables",
                            Name = "user",
                            UpdatedAt = new DateTime(2025, 8, 19, 14, 52, 59, 308, DateTimeKind.Utc).AddTicks(7067)
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2025, 8, 19, 14, 52, 59, 308, DateTimeKind.Utc).AddTicks(7068),
                            Description = "Client StartingBloch - Accès restreint à ses propres brevets uniquement",
                            Name = "client",
                            UpdatedAt = new DateTime(2025, 8, 19, 14, 52, 59, 308, DateTimeKind.Utc).AddTicks(7069)
                        });
                });
